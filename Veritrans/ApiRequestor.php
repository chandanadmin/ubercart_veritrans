...
/**
 * @file
 * Contains processing of API request.
 */
...
class CommerceVeritrans_ApiRequestor {
  ...
  /**
   * Function for POST Url processing.
   */
  ...
  /**
   * Function to make remote call using Curl.
   */
  public static function remoteCall($url, $server_key, $data_hash, $post = TRUE) {
    ...
    curl_setopt($ch, CURLOPT_CAINFO, dirname(__FILE__) . "/../data/cacert.pem");
