...
/**
 * @file
 * Contains sanitize data required for payment processing.
 */
...
class UbercartVeritrans_Sanitizer {
  ...
  /**
   * Static function to sanitize json request.
   */
  ...
  /**
   * Static function to sanitize field items details.
   */
  ...
  /**
   * Static function to sanitize customer details field.
   */
  ...
  /**
   * Static function to sanitize billing address field.
   */
  ...
  /**
   * Static function to sanitize shipping address field.
   */
  ...
  /**
   * Static function to sanitize phone field.
   */
  ...
  /**
   * Function to whitelist a string.
   */
  ...
  /**
   * Function to make string in uppercase.
   */
